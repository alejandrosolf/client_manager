...
class CreateClientWindow(Toplevel, CenterWidgetMixin):
    def __init__(self, parent):
        ...
        self.build()
        self.center()
        self.transient(parent) # lockear ventana pricipal
        self.grab_set() # lockear ventana principal
    ...
    def validate(self, event, index):
        ...
        # cambiar el estado de del boton en base a las validaciones
...
class MainWindow(Tk, CenterWidgetMixin):
    """Clase para generar interfaz grafica"""
    def __init__(self):
        super().__init__()
    ...
    def build(self):
        ...
        Button(frame, text='Borrar', command=self.delete).grid(column=2, row=0)
